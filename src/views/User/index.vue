<template>
    <div>
        <el-card>
            <el-input style="width:240px" @clear="getUserList" clearable v-model="searchForm.name" placeholder="根据用户姓名查询详情" class="input-with-select" @keyup.enter>
                <template #append>
...
<!-- ! table -->
        ...
        <el-pagination v-if="searchForm.name==''" style="margin-top:20px" :current-page="searchForm.pageNo" :page-size="searchForm.pageSize"
                :page-sizes="[10, 20, 30, 40]" layout="->,total, sizes, prev, pager, next, jumper" :total="searchForm.total"
